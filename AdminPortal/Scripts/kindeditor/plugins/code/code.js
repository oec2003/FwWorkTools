            ...
            html = ['<div style="padding:10px 20px;">',
				'<div class="ke-dialog-row">',
				    '<select class="ke-code-type">',
                        ...
                        '<option value="xml, xhtml, xslt, html, xhtml">HTML</option>',
                        ...
                        '<option value="java">Java</option>',
				        '<option value="as3, actionscript3">ActionScript3</option>',
				        '<option value="bash, shell">Bash/shell</option>',
				        '<option value="cf, coldfusion">ColdFusion</option>',
				        '<option value="cpp, c">C++</option>',
				        '<option value="delphi, pas, pascal">Delphi</option>',
				        '<option value="diff, patch">Diff</option>',
				        '<option value="erl, erlang">Erlang</option>',
				        '<option value="groovy">Groovy</option>',
				        '<option value="jfx, javafx">JavaFX</option>',
				        '<option value="perl, pl">Perl</option>',
                        '<option value="php">PHP</option>',
				        '<option value="plain, text">Plain Text</option>',
				        '<option value="ps, powershell">PowerShell</option>',
