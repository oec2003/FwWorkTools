...
namespace FW.WT.LinqDataModel
{
    ...
    partial void InsertCodeLib(CodeLib instance);
    partial void UpdateCodeLib(CodeLib instance);
    partial void DeleteCodeLib(CodeLib instance);
    #endregion
		
		public WTDataContext() : 
				base(global::FW.WT.LinqDataModel.Properties.Settings.Default.wtConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<CodeLib> CodeLib
		{
			get
			{
				return this.GetTable<CodeLib>();
			}
		}
		
		public System.Data.Linq.Table<CodeLibRelationTag> CodeLibRelationTag
		{
			get
			{
				return this.GetTable<CodeLibRelationTag>();
			}
		}
	}
	...
	public partial class Tags : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _UseCount;
    ...
    partial void OnUseCountChanging(System.Nullable<int> value);
    partial void OnUseCountChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_UseCount", DbType="Int")]
		public System.Nullable<int> UseCount
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.CodeLib")]
	public partial class CodeLib : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private int _CodeLibID;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnCodeLibIDChanging(int value);
    partial void OnCodeLibIDChanged();
    partial void OnTitleChanging(string value);
    partial void OnTitleChanged();
    partial void OnSummaryChanging(string value);
    partial void OnSummaryChanged();
    partial void OnCodeContentChanging(string value);
    partial void OnCodeContentChanged();
    ...
    partial void OnModifyIPChanging(string value);
    partial void OnModifyIPChanged();
    #endregion
        ...
        [global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_CodeLibID", DbType = "Int NOT NULL IDENTITY", IsPrimaryKey = true, IsDbGenerated = true)]
		public int CodeLibID
		{
			get
			{
				return this._CodeLibID;
			}
			set
			{
				if ((this._CodeLibID != value))
				{
					this.OnCodeLibIDChanging(value);
					this.SendPropertyChanging();
					this._CodeLibID = value;
					this.SendPropertyChanged("CodeLibID");
					this.OnCodeLibIDChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CodeContent", DbType="NVarChar(MAX)")]
		public string CodeContent
		{
			...
			set
			{
				if ((this._CodeContent != value))
				{
					this.OnCodeContentChanging(value);
					this.SendPropertyChanging();
					this._CodeContent = value;
					this.SendPropertyChanged("CodeContent");
					this.OnCodeContentChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ModifyBy", DbType="NVarChar(10)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ModifyIP", DbType="NVarChar(50)")]
		public string ModifyIP
		{
			get
			{
				return this._ModifyIP;
			}
			set
			{
				if ((this._ModifyIP != value))
				{
					this.OnModifyIPChanging(value);
					this.SendPropertyChanging();
					this._ModifyIP = value;
					this.SendPropertyChanged("ModifyIP");
					this.OnModifyIPChanged();
				}
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.CodeLibRelationTag")]
	public partial class CodeLibRelationTag
	{
		
		private System.Nullable<int> _CodeLibID;
		
		private System.Nullable<int> _TagID;
		
		public CodeLibRelationTag()
		{
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CodeLibID", DbType="Int")]
		public System.Nullable<int> CodeLibID
		{
			get
			{
				return this._CodeLibID;
